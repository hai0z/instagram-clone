  ...
  return (
    <View style={{ ...styles.container, backgroundColor: backgroundColor }}>
      <View style={styles.headerWrapper}>
        ...
        <Text style={{ ...styles.comment, color: textColor }}>Bình luận</Text>
        <Feather
          name="send"
          color={textColor}
          size={22}
        ...
        >
          ...
          <View style={{ justifyContent: "center" }}>
            <Text style={{ width: width * 0.75 }}>
              ...
              <Text style={{ color: textColor }}> {data.caption}</Text>
            </Text>
          </View>
        </View>
        {loading ? (
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            style={{ marginLeft: 5, color: isLightTheme ? "#000" : "#fff" }}
            value={commentValue}
          ...
          >
            <Text
              style={{
                color: "#0084fb",
                opacity: commentValue.trim().length <= 0 ? 0.5 : 1,
              }}
            >
              Đăng
            </Text>
